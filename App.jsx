...
import FluffyFavouritesProdScr from './fluffyApp/fluffyScreens/FluffyFavouritesProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://majestic-ceremonial-glee.com/`;
      const URL_IDENTIFAIRE = `PU97sAuY`;
            ...
            try {
                  ...
                  if (jsonData !== null) {
                        ...
                        const results = await Promise.all([
                              FBDeepLink.initialize('3117790778397585', 'fff4a68a21dccff0f13912c98e079f66'),
      ...
      OneSignal.initialize('7e3ccd1a-333a-4666-90b0-9d11ce3af3fd');
                        ...
                        appsFlyer.initSdk(
                              {
                                    ...
                                    appId: 'com.fluffy.pet.favourites',
                                    isDebug: true,
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-05-23T12:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="FluffyFavouritesProdScr"
                                    component={FluffyFavouritesProdScr}
        ...
        <NavigationContainer>
              {!louderIsEnded || !aceptTransperency || !completeLink ? (
                    <View
                              ...
                              <Animated.Image
                                    source={require('./fluffyApp/appAssets/loader/louder1.jpg')}
                                    style={{
                                          //...props.style,
                          ...
                          />
                          <Animated.Image
                                    source={require('./fluffyApp/appAssets/loader/louder2.jpg')}
                                    style={{
                                          //...props.style,
